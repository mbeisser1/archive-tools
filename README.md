...
- **message-vault** — `convert-media.py` / `sync-media.py` import `lib.media_convert`; `scripts/*-vcf.sh` and `convert-heic.sh` delegate to CLIs. One-off folder jobs use `images-to-jpg.py` and `videos-to-mp4.py` here directly.
